...
class TestVector(unittest.TestCase):
    ...
    def test_add(self):
        ...
        v3 = v1 + v2
        self.assertVectorsAlmostEqual(v3.coordinates, [7.089, -7.23])

    def test_subtract(self):
        v1 = Vector([7.119, 8.215])
        v2 = Vector([-8.223, 0.878])
        v3 = v1 - v2
        self.assertVectorsAlmostEqual(v3.coordinates, [15.342, 7.337])

    def test_multiply_scalar(self):
        v1 = Vector([1.671, -1.012, -0.318]) * 7.41
        self.assertVectorsAlmostEqual(v1.coordinates, [12.38211, -7.49892, -2.35638])
    ...
    def test_magnitude(self):
        ...
        self.assertAlmostEquals(v2.magnitude(), 10.884187567292289)

    def test_normalize(self):
        v1 = Vector([5.581, -2.136])
        self.assertVectorsAlmostEqual(v1.normalize().coordinates, [0.9339352140866403, -0.35744232526233])

        v2 = Vector([1.996, 3.108, -4.554])
        self.assertVectorsAlmostEqual(v2.normalize().coordinates, [0.3404012959433014, 0.5300437012984873, -0.7766470449528029])
